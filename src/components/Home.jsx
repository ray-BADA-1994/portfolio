  ...
  return (
    <div className="h-[100vh] bg-black flex justify-center items-center relative">
      <div className=" h-screen lg:grid grid-cols-[2fr_1fr]y lg:grid-cols-[1fr_400px] flex flex-col w-full px-4 md:px-0 md:w-[400px] lg:w-full justify-center items-start gap-10 lg:gap-20">
        {/* LEFT SIDE */}
        <div className="flex justify-end items-center lg:h-full">
          <div className="home-content flex-1y lg:h-full  flex flex-col justify-center space-y-5 lg:space-y-10">
            <h1 className="my-name w-fit font-light text-base  text-white border px-2 py-1">
              Chinwendu Chukwu
            </h1>
            <div className={`first-introduction`}>
              <p className="md:text-2xl md:leading-[28px] font-semibold lg:font-normal lg:text-[60px] lg:leading-[65px] 2xl:text-[82px] 2xl:leading-[86px] 2xl:w-[700px]y text-white">
        ...
        <div className="lg:h-full space-y-4 lg:w-[400px]y pl-5 flex flex-col justify-center gap-10 border-l border-[rgba(255,255,255,0.4)] md:border-[rgba(255,255,255,0.1)]">
          ...
          <div className="skills space-y-4">
            <h3 className="font-medium text-[rgba(255,255,255,0.8)] text-lg md:text-2xl">
              Skills:
            </h3>
            <div className=" flex items-center gap-3 flex-wrap">
              {skillsArr.map((datum, i) => (
                <span
                  key={i}
                  className="text-xs md:text-sm font-light cursor-pointer hover:border-[rgba(255,255,255,0.5)] transition-all duration-300 ease-in-out p-1 rounded-lg border border-[rgba(255,255,255,0.2)] text-white"
                >
                  {datum}
                </span>
              ))}
